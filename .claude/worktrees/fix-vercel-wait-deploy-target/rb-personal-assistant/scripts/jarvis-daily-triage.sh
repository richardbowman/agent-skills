...
SUMMARY=$($GEMINI_BIN --prompt "Triage my latest Gmail inbox. Summarize any urgent alerts or action items concisely. Archive routine newsletters, promotional items, and shipping notifications. Move condo notices to Home. Provide a clean, markdown summary." --approval-mode=yolo --skip-trust 2>&1)
